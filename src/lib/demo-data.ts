...
export const demoTranscript: TranscriptTurn[] = [
  { id: "t1", callId: "call_2847", speaker: "ai", text: "Thank you for calling CloudServe support. I'm Ava, an AI assistant — just so you know, you're speaking with an automated system. How can I help?", timestamp: "00:00", intent: "general", confidence: 0.99 },
  { id: "t2", callId: "call_2847", speaker: "caller", text: "Yeah, I just got charged $247.50 and I cancelled my subscription two weeks ago. I need this refunded.", timestamp: "00:12", intent: "billing", confidence: 0.94 },
  { id: "t3", callId: "call_2847", speaker: "ai", text: "I understand. Let me look up your account. According to our knowledge base article KB-142 on cancellation and billing, charges posted within 30 days of cancellation should be automatically reversed. Can you confirm the email on your account?", timestamp: "00:18", intent: "billing", confidence: 0.91 },
  { id: "t4", callId: "call_2847", speaker: "caller", text: "james.morrison@gmail.com. But I already talked to someone last week and they said it would be handled. This is getting ridiculous.", timestamp: "00:45", intent: "billing", confidence: 0.89 },
  ...
  { id: "t6", callId: "call_2847", speaker: "caller", text: "Five to seven days? I need this money now. I've already been waiting two weeks — this is completely unacceptable.", timestamp: "01:48", intent: "billing", confidence: 0.92 },
  ...
  { id: "t8", callId: "call_2847", speaker: "caller", text: "Finally. Yes, please do that. I don't want to call back again.", timestamp: "02:30", intent: "billing", confidence: 0.90 },
  { id: "t9", callId: "call_2847", speaker: "ai", text: "I'm transferring you now to Maria in our billing team. She'll have your full call context and refund details. Your reference number is REF-2847-JM. You should not need to repeat any information. Thank you for your patience, James.", timestamp: "02:45", intent: "general", confidence: 0.99 }
];
